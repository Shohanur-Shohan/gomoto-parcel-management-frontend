...
const DeliveryMenNavLink = () => {
  return (
    <>
      <NavLink
        to={"/"}
        className="flex items-center gap-3 rounded-lg px-3 py-2 transition-all hover:bg-muted hover:text-primary active:bg-muted"
      >
        <svg
...
export default DeliveryMenNavLink;
